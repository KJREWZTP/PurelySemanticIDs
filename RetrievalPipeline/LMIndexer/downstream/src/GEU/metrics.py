...
def evaluate_rec_once(topk_preds, groundtruth):
...
def evaluate_rec(user_item_scores, groudtruth, topk=10):
    ...
    for uid in user_item_scores:
        ...
        try:
            ...
            result = evaluate_rec_once(topk_preds, groudtruth[uid])
