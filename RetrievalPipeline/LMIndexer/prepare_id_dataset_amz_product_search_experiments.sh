    ...
    for DEPTH in "${DEPTHS[@]}"; do
      for LEARNING_RATE in "${LEARNING_RATES[@]}"; do
        for BATCH_SIZE in "${BATCH_SIZES[@]}"; do
          ...
          # Inference command
          # LINE_PROFILE=1 python -m kernprof -lvr "$DOWNSTREAM_DIR/src/rqvae/vec_rqvae_infer.py" \
          ...
          SEMANTIC_MODE_NOCONFLICT_1="rqvae-${CODEBOOK_SIZE}-depth${DEPTH}-combined_order-noconflict-candidate"
