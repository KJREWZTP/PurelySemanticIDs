...
def it2semantic_token(inputs, mode, max_len=None):    
    ...
    elif mode in ['rqvae', 'ours', 'ours-recon2', 'ours-recon3', 'ours-dim256', 'ours-dim128'] or 'rqvae' in mode:
        if isinstance(inputs, list):
...
if args.semantic_id_mode not in ['atomic', 'ours', 'ours-recon2', 'ours-recon3', 'ours-dim256', 'ours-dim128'] or 'rqvae' in args.semantic_id_mode or 'hcindexer' in args.semantic_id_mode :
